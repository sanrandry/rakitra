  ...
  <div>
    <v-container>
      ...
      <p>
        ...
        du site et des services par ________________ et de définir les
        ...
        services proposés par le site. www.rakitra.mg se réserve le droit de
        modifier unilatéralement et à tout moment le contenu des présentes CGU.
      </p>
      <div>
        <h2>Article 1 : Les mentions légales</h2>
        <p>
          L’édition et la direction de la publication du site www.rakitra.mg est
          assurée par la société ASA. Adresse e-mail ________________. Joignable
          aux numéros :
        </p>
      </div>
      <div>
        ...
        <p>
          Le site www.rakitra.mg permet à l'Utilisateur un accès gratuit à un
        ...
        <p>
          ...
          responsabilité de www.rakitra.mg. Dans ces cas, l’Utilisateur accepte
        ...
        <div>
          ...
          <p>
            Le site ne collecte aucune donnée concernant les Utilisateurs.
          </p>
        </div>
        <div>
          ...
          <p>
            ...
            (textes, images, son…) font l'objet d'une protection par la
            législation relative à la propriété intellectuelle et plus
            ...
            strictement interdite. L'Utilisateur qui reproduit, copie ou publie
        ...
        <div>
          ...
          <p>
            Les sources des informations diffusées sur le site www.rakitra.mg
          ...
          <p>
            ...
            régulières, le site www.rakitra.mg ne peut être tenu responsable de
          ...
          <p>
            Le site www.rakitra.mg ne peut être tenu pour responsable
        ...
        <div>
          ...
          <p>
            ...
            du site www.rakitra.mg. Ce dernier n’a pas de contrôle sur les pages
        ...
        <div>
          ...
          <p>
            ...
            qui sont nécessaires à l’utilisation du site www.rakitra.mg. Les
        ...
        <div>
          ...
          <p>
            ...
            les tribunaux malgaches seront seuls compétents pour en connaître.
          </p>
          <p>
